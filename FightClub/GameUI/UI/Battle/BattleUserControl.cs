...
namespace GameUI
{
    ...
    public partial class BattleUserControl : BaseUserConrol, IBattlePageView
    {
        ...
        {
            get { return FirstPlayerName.Text; }
            set { FirstPlayerName.Text = value; }
        }
        public int BattleFirstPlayerHP
        {
            get { return FirstPlayerHP.Value; }
            set { FirstPlayerHP.Value = value; }
        }
        public int BattleFirstPlayerHpMax
        {
            get { return FirstPlayerHP.Maximum; }
            set { FirstPlayerHP.Maximum = value; }
        }
        public string BattleSecondPlayerName
        {
            get { return SecondPlayerName.Text; }
            set { SecondPlayerName.Text = value; }
        }
        public int BattleSecondPlayerHP
        {
            get { return SecondPlayerHP.Value; }
            set { SecondPlayerHP.Value = value; }
        }
        public int BattleSecondPlayerHpMax
        {
            get { return SecondPlayerHP.Maximum; }
            set { SecondPlayerHP.Maximum = value; }
        }
        public string BattleResultMessage
        {
            get { return BattleResult.Text; }
            set { BattleResult.Text = value; }
        }
        public bool RadioButtonsVisible
        {
            get { return RadioButtons.Visible; }
            set { RadioButtons.Visible = value; }
        }
        public bool NewBattleButtonVisible
        {
            get { return NewBattle.Visible; }
            set { NewBattle.Visible = value; }
        }
        public string AddBattleLog
        {
            get { return BattleLog.Text; }
            set { BattleLog.Text += value; }
        }
